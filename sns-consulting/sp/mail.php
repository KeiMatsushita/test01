...
<!-- End Google Tag Manager (noscript) -->
		...
		<section id="form" class="form_area conf">
			<section class="inner">
				<h2><img src="img/form_tit.jpg" alt="まずはお気軽にご相談ください お問い合わせフォーム ※マーク 必須項目"></h2>
				<?php if ($empty_flag == 1) { ?>
					<div class="err">
						<h4>入力にエラーがあります。<br>下記をご確認の上「戻る」ボタンにて<br>修正をお願い致します。</h4>
						<?php echo $errm; ?>
